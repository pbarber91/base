...
const NO_CHURCH_VALUE = "__none__";
...
export default function Profile() {
  ...
  const handleSave = () => {
    ...
    // Normalize "no church" selection
    if (payload.church_id === NO_CHURCH_VALUE) payload.church_id = null;
  ...
  const handleStartEdit = () => {
    ...
    setEditData({
      ...
      bio: profile?.bio || "",
      // IMPORTANT: Radix Select can crash if value is "" and no matching item exists
      church_id: churchId ? String(churchId) : NO_CHURCH_VALUE,
                ...
                <div className="space-y-4 max-w-md">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select
                        value={editData.church_id ?? NO_CHURCH_VALUE}
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value={NO_CHURCH_VALUE}>No church</SelectItem>
                          {churches.map((c: any) => (
